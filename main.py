...
def get_weather_forecast(city):
    r = requests.get(f"https://archive-api.open-meteo.com/v1/era5?latitude={cities[city]['lat']}&longitude={cities[city]['long']}&start_date=2022-10-09&end_date=2022-10-11&hourly=temperature_2m,windspeed_100m")
    print(f"https://archive-api.open-meteo.com/v1/era5?latitude={cities['Madrid']['lat']}&longitude={cities['Madrid']['long']}&start_date=2022-10-09&end_date=2022-10-11&hourly=temperature_2m,windspeed_100m")
    data = r.json()
    return data

def enhance_generation_forecast(forecast,name):
    ...
    ts.to_csv(f"data/result{name}.csv")
...
if __name__ == '__main__':
    ...
    for key in cities.keys():
        ...
        enhance_generation_forecast(forecast,key)
